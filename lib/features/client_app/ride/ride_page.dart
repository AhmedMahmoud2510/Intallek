...
class RidePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // الخريطة (قابلة للتفاعل)
          const GoogleMap(
            initialCameraPosition: CameraPosition(
              target: LatLng(24.7136, 46.6753), // الرياض مثلاً
              zoom: 12,
            ),
          ),
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        SvgImage(
                          imagePath: Assets.imagesIconsHomeOutline,
                          height: 18.h,
                        ),
                        Text(
                          S.of(context)!.home,
                        ...
                        const Spacer(),
                        SvgImage(
                          imagePath: Assets.imagesIconsSavedPlace,
                          height: 20.h,
                        ),
                        Text(
                    ...
                    Row(
                      ...
                      children: [
                        SvgImage(
                          imagePath: Assets.imagesIconsClock,
                          height: 22.h,
                        ),
                        Text(
