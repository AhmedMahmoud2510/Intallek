...
class SelectDestinationDeliveryPage extends StatelessWidget {
  const SelectDestinationDeliveryPage({super.key, this.controller});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text('60 ${S.of(context)!.sar}', style: AppStyle.black16W400Style),
          ],
        ),
        16.verticalSpace,
        ...
        Row(
          ...
          children: [
            ...
            Text('2 ${S.of(context)!.items}', style: AppStyle.black16W400Style),
          ],
        ),
        16.verticalSpace,
        Text(
